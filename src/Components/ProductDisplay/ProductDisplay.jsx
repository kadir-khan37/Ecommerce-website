...
const ProductDisplay = (props) => {
  ...
  <button onClick={()=>{addTocart(product.id); alert(`${product.name} Added to your Cart`)}}>Add to cart</button>
  <div className="productdisplay-right-category">
    <span>Category: <span> women , t-shirt , croptop</span></span>
  </div>
  <div className="productdisplay-right-category">
    <span>Tags: <span> trendy , Latest , Modern</span></span>
  </div>
